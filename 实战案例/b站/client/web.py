...
from 日常练习.实战案例.b站.client import common
...
class BLiveClient(common.WebSocketClientBase):
    """
    web端客户端
    ...
    async def _send_auth(self):
        ...
        await self._websocket.send_bytes(self._make_packet(auth_params, common.Operation.AUTH))
